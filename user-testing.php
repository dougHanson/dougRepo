    ...
    <div class="wrapper__inner">
      ...
      <div id="container">
        ...
        <article class="container">
          ...
          <!-- header image -->
          <!-- <header class="header"> -->
            <div class="bg-img" style="position: static; max-height: 360px; margin-top: 40px;">
              <img src="img/user-testing-doug-hanson.jpg" data-src="img/user-testing-doug-hanson.jpg" class="lazy-load" alt="Interactive Jobs Portal" 
                   style="width: 100%; bottom: 0; height: auto; min-width: none; min-height: none; position: static; "/>
            </div>
          <!-- </header> -->
