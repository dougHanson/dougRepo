...
<link rel="icon" type="image/png" sizes="230x230" href="img/favicons/favicon-230x230.png">
...
<meta property="twitter:image" content="img/favicons/twitter.png">
<meta property="og:image" content="img/favicons/open-graph.png">
<link rel="apple-touch-startup-image" media="(device-width: 768px) and (device-height: 1024px) and (orientation: landscape) and (-webkit-device-pixel-ratio: 1)" href="img/favicons/apple-touch-startup-image-1024x748.png">
...
<link rel="apple-touch-startup-image" media="(device-width: 768px) and (device-height: 1024px) and (orientation: landscape) and (-webkit-device-pixel-ratio: 2)" href="img/favicons/apple-touch-startup-image-2048x1496.png">
